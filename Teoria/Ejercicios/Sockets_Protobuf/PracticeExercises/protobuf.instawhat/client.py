...
parser = argparse.ArgumentParser(description='InstaWhat client')
...
post_photo_parser.add_argument("photo_url", help="URL of the photo to post")

comment_photo_parser = subparsers.add_parser('comment_photo', help='Comment on a photo')
comment_photo_parser.add_argument("owner_id", help="ID of the photo owner")
comment_photo_parser.add_argument("photo_url", help="URL of the photo to comment on")
comment_photo_parser.add_argument("comment", help="Comment text")

rate_photo_parser = subparsers.add_parser('rate_photo', help='Rate a photo')
rate_photo_parser.add_argument("owner_id", help="ID of the photo owner")
rate_photo_parser.add_argument("photo_url", help="URL of the photo to rate")
...
like_photo_parser.add_argument("owner_id", help="ID of the photo owner")
like_photo_parser.add_argument("photo_url", help="URL of the photo to like")

delete_photo_parser = subparsers.add_parser('delete_photo', help='Delete a photo')
delete_photo_parser.add_argument("photo_url", help="URL of the photo to delete")

get_last_photos_parser = subparsers.add_parser('get_last_photos', help='Get last photos of a user')
get_last_photos_parser.add_argument("user_id", help="ID of the user whose photos to retrieve")
